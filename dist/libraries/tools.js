...
function compileChimlFile(chiml) {
    ...
    const pkgDstPath = path_1.resolve(path_1.dirname(chiml), "node_modules", "chiml", "package.json");
    const pkgSrcPath = path_1.resolve(path_1.dirname(path_1.dirname(__dirname)), "package.json");
